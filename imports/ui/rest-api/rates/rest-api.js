...
JsonRoutes.add("get", "/find_rate/:selector/:options", function(
  req,
  res,
  next
) {
...
JsonRoutes.add("get", "/findOne_rate/:selector/:options", function(
  req,
  res,
  next
) {
...
JsonRoutes.add("get", "/update_rate/:selector/:modifier/:options", function(
  req,
  res,
  next
) {
